...
export const metadata = genMeta({
	...
	keywords: 'security blog, cybersecurity research, FiveM security, reverse engineering, vulnerability research, encryption analysis, responsible disclosure, security analysis',
	path: '/blog',
});

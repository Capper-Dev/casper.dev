...
export default function AboutPage() {
	return (
		<PageTransition>
			<div className='h-screen flex flex-col justify-center max-w-3xl mx-auto px-6 overflow-hidden'>
				<motion.div className='space-y-6' variants={containerVariants} initial='hidden' animate='visible'>
					...
					<motion.div className='grid md:grid-cols-2 gap-4 text-sm' variants={containerVariants}>
						<motion.div
							className='flex items-start gap-3 p-4 bg-gradient-to-r from-white/5 to-neutral-300/5 border border-neutral-700/50 rounded-xl hover:border-neutral-600 transition-colors'
						...
						<motion.div
							className='flex items-start gap-3 p-4 bg-gradient-to-r from-neutral-400/5 to-neutral-600/5 border border-neutral-700/50 rounded-xl hover:border-neutral-600 transition-colors'
							variants={itemVariants}
						...
						<motion.div
							className='flex items-start gap-3 p-4 bg-gradient-to-r from-neutral-600/5 to-white/5 border border-neutral-700/50 rounded-xl md:col-span-2 hover:border-neutral-600 transition-colors'
							variants={itemVariants}
						...
						<motion.div className='grid grid-cols-3 md:grid-cols-6 gap-3' variants={containerVariants}>
							{technologies.map((tech, index) => (
								<motion.div
									...
									className='p-3 bg-neutral-900/50 border border-neutral-800 rounded-lg text-center text-xs hover:border-neutral-700 transition-colors cursor-default'
								>

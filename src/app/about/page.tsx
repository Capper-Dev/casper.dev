...
export const metadata = genMeta({
	...
	keywords: 'about Casper Truberg, self-taught developer, React developer, TypeScript developer, Next.js developer, hobby programmer, web development journey, Denmark developer',
	path: '/about',
});

...
export const metadata = genMeta({
	title: "Experience",
	description:
		"Explore my self-taught journey through modern web development. From frontend design with React and Tailwind CSS to full-stack development with Node.js, tRPC, and Supabase.",
	keywords:

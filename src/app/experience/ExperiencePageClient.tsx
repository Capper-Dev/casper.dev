...
export default function ExperiencePage() {
	return (
		<PageTransition>
			...
			<div className='h-screen flex flex-col justify-center max-w-3xl mx-auto px-6 relative z-10 overflow-hidden'>
				<motion.div className='space-y-8' variants={containerVariants} initial='hidden' animate='visible'>
					...
					<motion.div className='grid md:grid-cols-2 gap-6' variants={containerVariants}>
						<motion.div
							className='p-6 bg-neutral-900/40 backdrop-blur-sm border border-neutral-700/50 rounded-xl hover:border-neutral-600 transition-colors'
						...
						<motion.div
							className='p-6 bg-neutral-900/40 backdrop-blur-sm border border-neutral-700/50 rounded-xl md:col-span-2 hover:border-neutral-600 transition-colors'
							variants={itemVariants}
